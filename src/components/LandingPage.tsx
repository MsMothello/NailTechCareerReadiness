...
export default function LandingPage({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* TESTIMONIALS */}
      <section className="py-6 px-4 mb-4 bg-white">

        <div className="max-w-3xl mx-auto bg-gradient-to-b from-pink-50 to-purple-50 rounded-lg px-5 py-5">

          <div className="max-w-2xl mx-auto">

            <h3 className="text-center text-xl mb-5 text-gray-600">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <p className="text-gray-700 mb-2">
                  "This literally saved me from making a $5K mistake. I thought
                  I was ready but the quiz showed me I needed to save more
                  first."
                </p>
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <p className="text-gray-700 mb-2">
                  "Honestly didn't expect much from a free quiz but wow.
                  Knowing the real costs upfront changed everything for me."
                </p>
